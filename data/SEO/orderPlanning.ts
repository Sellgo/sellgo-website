...
export const seoData: SEODetails = {
	title: `Sellgo -  AiStock Order Planning: Amazon All-In-One Tool`,
	...
	we’ll even let you know what your competitors are doing and alert you to where they rank in the Amazon 
	search result pages.`,
	imageUrl: ``,
	keywords: [
		'sellgo',
		'sellgo order planning',
		'sellgo inventory planning',
		'smart order',
		'sostocked'
	],
	slug: '/order-planning'
