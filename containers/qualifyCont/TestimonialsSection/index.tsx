...
const TestimonialsSection: React.FC<Props> = () => {
	const testimonials = [
		<section className={`page-container ${styles.otherInfoSection}`}>
			<h2 className={styles.sectionHeading}>a</h2>
			<div className={styles.testimonialTextWrapper}>
				<p>
					"AiStock is an amazing software that allows us to manage our product
					catalogs on a sophisticated system. It's huge!"
				</p>

				<div className={styles.testimonialAuthor}>
					{/* <img src="andrewErickson.png" alt="author" /> */}
					<div className={styles.authorDetails}>
						<span className={styles.name}>Jack Y</span>
						<span className={styles.title}>CEO of Private Label Brand</span>
						{/* <a
