...
import PartnershipFormSubmitConfirm from '../../../components/PartnershipFormSubmitConfirm';
	...
	return (
		<>
			...
			>
				...
				<FormInput
					className={styles.formInput}
					label="How do you plan to market Sellgo and our tools as an partnership partner? *"
					id="marketingPlan"
					type="text"
					name="marketingPlan"
					onChange={handleChange}
				...
				<FormInput
					className={styles.formInput}
					label={`What will make your life easier as our partnership?`}
				...
				<p className={styles.formSubmitInfo}></p>

				<MultiSelectCheckBoxInput
					options={[
						`I understand and agree to the terms of the partner
						program agreement.*`
					]}
					onChange={handleChange}
					id={'privacyPolicyAck'}
