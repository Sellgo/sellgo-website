export const benefitsData = [
	...
	},
	{
		...
		details: `With thousands of products within a single catalog, data 
		can get mixed up! Get alerts when you upload catalogs with file errors including missing ASINs, 
		repetitive SKUs, and more.`,
		popularFeaturesList: [
			{
				title: 'Feature 1',
				details: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
