...
const HeroBox: React.FC<Props> = () => {
	...
	return (
		<section className={`page-container ${styles.heroBox}`}>
			<h1>Operation Analytics for Scale</h1>
			<h2 className="secondary-heading">
				Ready to grow and scale, from day one
			</h2>
			<p>
				Everything you need, in one dashboard. We&apos;ll put all your data in
				one place so you can see your entire multi-channel landscape, in real
				time.
			</p>
