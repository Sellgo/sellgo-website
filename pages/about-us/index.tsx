		...
		<main className={styles.aboutUs}>
			<section className={`page-container ${styles.welcomeSection}`}>
				<div className={styles.welcomeSection__text}>
					...
					<p>
						...
						Wholesale, we&apos;ve built our tools and services to encompass all
						sellers with any model and any level of experience including Amazon
						FBA or Amazon FBA as well as Wholesalers, Private Label Sellers, and
						Agencies.
					</p>

					<p>
						While our company is headquarter in Portland, Oregon, our team
						members span across the globe and are unified with the same passion
						and mission: to help Amazon sellers flourish. If you would like to
						learn more about Sellgo, our team, or our mission, we welcome you to
			...
			<section className={`page-container ${styles.contentSection}`}>
				...
				>
					...
					<p>
						...
						stage of their selling journey including product scouting to product
			...
			<section className={`page-container ${styles.contentSection}`}>
				<div className={`${styles.contentSection__text}`}>
					...
					<p>
						...
						and ending with the Professional plan. Each plan can be chosen based
						on the size and needs of your business. Check out of pricing plans
						below.
					</p>
			...
			<section className={`page-container ${styles.contentSection}`}>
				<div className={`${styles.contentSection__text}`}>
					<h2>Careers</h2>
					<p>
						We’re a global team of Amazon sellers and experts from 16 countries
						— and we’re proud to serve entrepreneurs and brands from around the
						world.
					</p>
					<CTAButton
						type="secondary"
