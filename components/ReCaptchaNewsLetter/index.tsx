...
const ReCaptchaNewsLetter: React.FC<Props> = (props) => {
	...
	return (
		<div className={styles.newsLetter}>
			...
			<p>Join our subscriber&apos;s list to get the latest update and articles delivered directly to your inbox.</p>
			...
			<div className={styles.importantNotes}>
				<p>
				We&apos;re committed to your privacy. Sellgo uses the information you provide 
				to us to contact you about our relevant content, products, and services. 
