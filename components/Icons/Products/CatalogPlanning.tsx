...
const CatalogPlanning: React.FC<Props> = (props) => {
	const { width, height, fill, isRainbow } = props;
	if (isRainbow) {
		return <Image src="/products-catalogPlanning.svg" width={width} height={height} />;
	}
	return (
        <svg
